...
regedit /s C:\Users\analyst\AppData\Local\Temp\MakeWindows10GreatAgain.reg
...
$shutUp10RepoPath = "C:\Users\analyst\AppData\Local\Temp\OOSU10.exe"
if (-not (Test-Path $shutUp10RepoPath)) {
  ...
  . $shutUp10RepoPath C:\Users\analyst\AppData\Local\Temp\shutup10.cfg /quiet /force
} else {
  Write-Host "$('[{0:HH:mm}]' -f (Get-Date)) ShutUp10 was already installed. Moving On."
}

# Remove the Edge shortcut from the Desktop
$lnkPath = "C:\Users\analyst\Desktop\Microsoft Edge.lnk"
